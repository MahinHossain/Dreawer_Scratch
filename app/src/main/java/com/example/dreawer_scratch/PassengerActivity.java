...
public class PassengerActivity extends FragmentActivity implements OnMapReadyCallback, View.OnClickListener {
    ...
    Button RequestAdoctor, logoutfroomPassenger, btnBeepStatus;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logoutfroomPassenger = findViewById(R.id.logoutfrompassengerId);
        ...
        logoutfroomPassenger.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        ParseQuery<ParseObject> doctorrequest = ParseQuery.getQuery("RequestCar");
        ...
        if (isRequestcancelled) {
            if (ContextCompat.checkSelfPermission(PassengerActivity.this,
                ...
                if (passengerCurrentLoaction != null) {
                    ...
                    ParseObject requestAcar = new ParseObject("RequestCar");
                    ...
                    requestAcar.saveInBackground(new SaveCallback() {
                        ...
                        public void done(ParseException e) {
                            ...
                            if (e == null) {
                                FancyToast.makeText(PassengerActivity.this, " Doctor request is sent ",
                    ...
                    FancyToast.makeText(PassengerActivity.this, " Unknown error", FancyToast.
                    ...
                    if (Requestlist.size() > 0 && e == null) {
                        ...
                        for (ParseObject Doctorrequest : Requestlist) {
                            Doctorrequest.deleteInBackground(new DeleteCallback() {
                                ...
                                public void done(ParseException e) {
                                    if (e == null) {
                                        FancyToast.makeText(PassengerActivity.this, " Doctor request deleted",
    ...
    void doctorUpdates() {
        ...
        timer.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                ParseQuery<ParseObject> patientObjectParseQuery = ParseQuery.getQuery("RequestCar");
                                            ...
                                            for (ParseUser doctrOfRequest : doctor) {
                                                ...
                                                if (ContextCompat.checkSelfPermission(PassengerActivity.this,
                                                    ...
                                                    if (mileDistaance < .05) {
                                                        ...
                                                        FancyToast.makeText(PassengerActivity.this, " Yes " +
