...
public class DoctorActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    private Button logoutfromdoctor, btnGetnearByRequest;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logoutfromdoctor = findViewById(R.id.logoutfromDoctrd);
        logoutfromdoctor.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    private void updateRequestListView(Location doctorlation) {
        ...
        if (doctorlation != null) {
            ...
            final ParseQuery<ParseObject> requestPatientquery = ParseQuery.getQuery("RequestCar");
                    ...
                    if (e == null) {
                        if (objects.size() > 0) {
                            ...
                            for (ParseObject nearRequest : objects) {
                                ...
                                float roundedValue = Math.round(KilometerDistanceToPatient * 100) / 100;
